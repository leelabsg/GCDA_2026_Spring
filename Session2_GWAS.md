# Practice Session #2: Genome-wide Association Studies (GWAS) (April 6, 2026)
...
This document was created on April 5, 2026 and the following contents were tested on the Lee Lab cluster (Ubuntu 24.04.4 LTS).
...
sudo docker pull wzhou88/saige:1.5.1
...
docker run -v /data/home/gcda_XXX/2_GWAS:/data/home/gcda_XXX/2_GWAS \
        wzhou88/saige:1.5.1 createSparseGRM.R \
...
```
docker run -v /data/home/gcda_XXX/2_GWAS:/data/home/gcda_XXX/2_GWAS \
        wzhou88/saige:1.5.1 step1_fitNULLGLMM.R \
        --plinkFile=/data/home/gcda_XXX/2_GWAS/genotype/nfam_100_nindep_0_step1_includeMoreRareVariants_poly_22chr \
...
docker run -v /data/home/gcda_XXX/2_GWAS:/data/home/gcda_XXX/2_GWAS \
        ...
        --outputPrefix=/data/home/gcda_XXX/2_GWAS/example_quantitative \
        --nThreads=8 \
        --IsOverwriteVarianceRatioFile=TRUE
```
...
```
docker run -v /data/home/gcda_XXX/2_GWAS:/data/home/gcda_XXX/2_GWAS \
        wzhou88/saige:1.5.1 step2_SPAtests.R \
...
# Example
scp 'gcda_XXX@147.47.200.131:~/YOUR_DIRECTORY/*.png' .
```
...
gwas <- read.table("~/2_GWAS/step2_quant.txt", header=T)
